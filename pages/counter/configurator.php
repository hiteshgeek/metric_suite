<?php
/**
 * Counter Configurator Page
 * Create and configure counter widgets with live preview
 */
...
// Check if editing existing counter
$editId = isset($_GET['id']) ? (int)$_GET['id'] : null;
$pageTitle = $editId ? 'Edit Counter' : 'Create Counter';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <!-- Scripts -->
    <script type="module">
        import { CounterConfigurator, ThemeSwitcher } from '<?= asset('metric-suite.js') ?>';

        // Initialize theme switcher
        new ThemeSwitcher('#theme-switcher', { showLabels: false });

        // Initialize configurator
        const container = document.getElementById('counter-configurator');
        const basePath = container.dataset.basePath || '';
        const editId = container.dataset.editId || null;

        const configurator = new CounterConfigurator(container, {
            saveEndpoint: basePath + '/api/counter.php',
